...
date: "2022-08-15"
categories: [code, setup, research]
# image: "image.jpg"
---
...
My [dev setup](../dev-setup/index.qmd) is a culmination of mostly research and some non-research tools that is mostly oriented towards working on Windows based local machines with WSL and Linux machines with GPUs. 